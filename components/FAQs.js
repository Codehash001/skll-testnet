    ...
    <div id='faqs'className='md:mx-16 mx-2 p-6 my-[44px] rounded-lg'>
      ...
      <Accordion open={open === 1} animate={customAnimation}>
        ...
        <AccordionBody className='text-justify dark:text-gray-300 text-gray-700 font-Archivo  text-[20px]'>
         Go to minting section and connect your wallet. Then choose the number that you need o mint and confirm the transaction.
        </AccordionBody>
      </Accordion>
      ...
      <Accordion open={open === 4} animate={customAnimation} className='ttext-black dark:text-whitefont-Archivo text-[22px]'>
