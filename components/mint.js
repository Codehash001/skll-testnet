...
useEffect(() => {
  ...
  return (
    ...
    <img src='/web01.png' class="dark:hidden blob w-[500px] h-[500px]  absolute top-[-50px] right-[-250px] -z-10 blur-md  bg-opacity-50 animate-pulse-slow"/>
    <img src='/web02.png' class="dark:hidden blob w-[500px] h-[500px] absolute bottom-[-70px] left-[-280px] -z-10 blur-md bg-opacity-60 animate-pulse-slow"/>
