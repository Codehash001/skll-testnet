    ...
    <p>
      <ul className='list-[lower-latin]'>
        ...
        <ul className='list-[lower-roman]'>
          ...
          <li>In general, information about Company or a Project should be considered &quot;material&quot; if:
            <ul className='list-disc'>
              <li>
          ...
          <li>
            ...
            <ul className='list-disc'>
              <li>Rarity tables.</li>
              <li>The rarity of each individual trait, layer or element included in the Project.</li>
              <li>Upcoming airdrops.</li>
              <li>Upcoming announcements by or on behalf of Company.</li>
              <li>Upcoming events by in collaboration with or on behalf of Company.</li>
              <li>Potential, future and ongoing collaborations and partnerships.</li>
              <li>Potential and future utility (including, without limitation, any products, benefits, services, privileges, rights or opportunities) to be offered to NFT holders.</li>
              <li>New key members of Company or Project team, including executives, officers, directors, employees, contractors or investors.</li>
            </ul>
          </li>
